...
export default function Home() {
  return (
    <main className="min-h-screen bg-white text-black font-prompt">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="text-left">
            ...
            <p className="text-base leading-relaxed">
              Offering mortgage assistance benefits helps attract top talent and
              retain valuable employees. We partner with lenders to ensure the best
              match – and we&apos;ll handle all of the paperwork.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="text-left order-2 md:order-1">
            ...
            <p className="text-base leading-relaxed whitespace-pre-line">
              Actively contribute to the financial wellness of your employees.
              With a secure living situation, employees can better focus on planning
              for the future, such as saving for retirement or investing in
              professional development. Financially secure employees are more
              likely to be financially responsible, which can lead to lower stress
              levels and a healthier work-life balance.
            </p>
          </div>
      ...
      <section className="relative bg-[url('/orangeswithbluebackground.png')] bg-cover bg-center text-white py-24 px-12 flex flex-col justify-center">
